...
CloudTier demo is a simple C# application, to demo how to use the transparent storage tiering SDK. 

You can run the demo application as the console app with below command in dos prompt:
Cloudtierdemo.exe -console
...
You can run the demo application as the Windows Forms GUI application with below command:
Cloudtierdemo.exe

How does CloudTier demo work?
